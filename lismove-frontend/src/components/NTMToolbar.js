...
export class MTableToolbar extends React.Component {
					...
					InputProps={{
						startAdornment: (
							<InputAdornment position="start">
								<Tooltip disableInteractive title={localization.searchTooltip}>
		...
		return (
            <div>
				{this.props.columnsButton && (
					<span>
            <Tooltip disableInteractive title={localization.showColumnsTitle}>
              <IconButton
                  color="inherit"
                  onClick={(event) =>
					  this.setState({
			...
			>
			  ...
			  >
				...
				{this.props.exportButton && (
					<span>
            <Tooltip disableInteractive title={localization.exportTitle}>
              <IconButton
                  color="inherit"
                  onClick={(event) =>
					  this.setState({
	...
	renderToolbarTitle(title) {
		...
		return <div className={classes.spacer}>{toolBarTitle}</div>;
	}
